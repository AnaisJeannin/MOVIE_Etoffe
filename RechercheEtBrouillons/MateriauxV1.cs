...
public class DemoV0 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(2) && !coutureActive)
        {
        ...
        // Les matériaux des rubans en cloth
        if (!modeCloth && Input.GetKeyDown(KeyCode.O) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Soie);
            Debug.Log("Matériau Soie appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.L) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Coton);
            Debug.Log("Matériau Coton appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.K) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Denim);
            Debug.Log("Matériau Denim appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.T) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Laine);
            Debug.Log("Matériau Laine appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.N) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Velours);
            Debug.Log("Matériau Velours appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.B) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Lin);
            Debug.Log("Matériau Lin appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.V) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Satin);
            Debug.Log("Matériau Satin appliqué");
        }

        if (!modeCloth && Input.GetKeyDown(KeyCode.J) && rubanSelectionne != null)
        {
            AppliquerMateriau(rubanSelectionne, Nylon);
            Debug.Log("Matériau Nylon appliqué");
        }
    }
    ...
    void AppliquerMateriau(GameObject ruban, Material mat)
    {
